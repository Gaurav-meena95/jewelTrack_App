           ...
           <View style={[styles.detailContent, { backgroundColor: theme.card }]}>
              ...
              <ScrollView>
                 ...
                 <View style={styles.detailStats}>
                    <View style={[styles.dStat, { backgroundColor: colorScheme === 'dark' ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 0, 0, 0.03)' }]}>
                       <Text style={[styles.dLabel, { color: theme.text }]}>Total</Text>
                       <Text style={[styles.dVal, { color: theme.text }]}>₹{activeOrder?.Total}</Text>
                    </View>
                    <View style={[styles.dStat, { backgroundColor: colorScheme === 'dark' ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 0, 0, 0.03)' }]}>
                       <Text style={[styles.dLabel, { color: theme.text }]}>Due</Text>
